...
from app.models import Avaliacao, Fornecedor, Produto, Usuario
...
class UsuarioTestCase(TestCase):
    def test_usuario_valido(self):
        usuario = Usuario(
            ...
            password="senha123",
            informacoes_de_contato="1234567890",
        )
        usuario.full_clean()
...
class AvaliacaoTestCase(TestCase):
    def setUp(self):
        ...
        self.usuario = Usuario.objects.create(
            username="usuario_teste", email="teste@teste.com"
        )
    ...
    def test_avaliacao_valida(self):
        ...
        avaliacao = Avaliacao(
            ...
            nota=5,
            comentario="Comentário longo o suficiente",
        )
    ...
    def test_avaliacao_invalida(self):
        ...
        avaliacao = Avaliacao(
            usuario=self.usuario, produto=self.produto, nota=0, comentario="Curto"
        )
        with self.assertRaises(ValidationError):
