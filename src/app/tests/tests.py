...
class UsuarioTestCase(TestCase):
    def test_usuario_valido(self):
        usuario = Usuario(username="usuario_teste", email="teste@teste.com", password = "senha123",telefone="1234567890")
        usuario.full_clean()

    def test_usuario_invalido(self):
        usuario = Usuario(username="usuario_teste", email="testeeste.com", password = "",telefone="1234")
...
class FornecedorTestCase(TestCase):
    def test_fornecedor_valido(self):
        fornecedor = Fornecedor(
            ...
            fornecedor_user=Usuario(username="usuario_teste", email="teste@teste.com", password = "senha123",telefone="1234567890", is_fornecedor=True, is_cliente=False),
            feira = FeiraFactory(),
